...
/*
** Define the number of datatypes that are supported by SAP.
*/
...
#define CS_FMT_SUBS_ILL_CHAR	(CS_INT)0x40
...
** with the SAP ASE "varchar" column type.
*/
...
**
** datatype 		The datatype field indicates what SAP
