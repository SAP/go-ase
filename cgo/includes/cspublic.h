...
**
** If 2.0 handshake is desired, or CS_SSLVER_20HAND.
*/
...
#define	CS_TLSVER_TLS10		CS_SSLVER_TLS1
...
#define CS_OPT_ISOLATION_MODE   (CS_INT)5051    /* Transaction isolation mode */

#define CS_MIN_OPTION           CS_OPT_DATEFIRST
#define CS_MAX_OPTION           CS_OPT_ISOLATION_MODE
...
#define CS_OPT_STATEMENT_SNAPSHOT		(CS_INT)11
#define CS_OPT_TRANSACTION_SNAPSHOT		(CS_INT)12
#define CS_OPT_READONLY_STATEMENT_SNAPSHOT	(CS_INT)13

/* CS_OPT_ISOLATION_MODE */
#define CS_OPT_ISOLATION_DEFAULT		(CS_INT)0
#define CS_OPT_ISOLATION_SNAPSHOT		(CS_INT)1
#define CS_OPT_ISOLATION_READONLY_SNAPSHOT	(CS_INT)2
...
#define CS_REQ_COMMAND_ENCRYPTION	(CS_INT)108

/*
** Minimum and maximum request capability values.
*/
#define CS_MIN_REQ_CAP		CS_REQ_LANG
#define CS_MAX_REQ_CAP		CS_REQ_COMMAND_ENCRYPTION
...
/* csdtset.c */
extern CS_RETCODE CS_PUBLIC cs_dt_set(
	CS_CONTEXT *context,
	CS_INT datatype,
	CS_VOID *dtval,
	CS_INT year,
